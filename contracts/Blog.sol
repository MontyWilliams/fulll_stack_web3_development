...
import "hardhat/console.sol"; // error Source "hardhat/console.sol" not found: File import callback not supported
                              // Comes from vs code becuse it is looking for node_modules in root: open in root dir
